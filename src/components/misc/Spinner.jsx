...
function Spinner(props) {
    ...
    return (
    	<>
	        { loading === true ?
	        <div className="">
	        	{ props.hideComponent !== undefined && props.hideComponent === true ?
	        		<></>
	        	:
	        		<>
	        			{props.component}
			    ...
			    <div role="status" className="fixed left-0 right-0 top-0 z-55 fixed flex justify-center items-center -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2 h-screen w-screen opacity-20 bg-gray-800 z-50">
