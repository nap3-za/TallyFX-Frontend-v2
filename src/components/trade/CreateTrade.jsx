...
function CreateTrade(props) {
  useEffect(() => {
	...
	return (
		...
		<button onClick={handleCreateTradeClick} type="button" data-modal-target="add-trade-modal" data-modal-toggle="add-trade-modal" className="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
...
CreateTrade.propTypes = {
	createTrade: PropTypes.func,
	getFieldChoices: PropTypes.func,
}


export default connect(null, { createTrade, getFieldChoices })(CreateTrade);
