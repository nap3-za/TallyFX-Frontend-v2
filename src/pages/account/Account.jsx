...
import AuthAccountDetails from "../../components/account/AuthAccountDetails";

import { updateAccount, getAccount } from "../../reduxApp/actions/account/actions";
...
function Account(props) {
    ...
    const populateResponse = (data) => {setResponse(data)}
    useEffect(
        () => {
            if (response !== null && response.isAuthUser === null) {
                props.getAccount(populateResponse, accountId);
            }
        }
    )
    ...
    return (
        <Spinner trigger={response.loading} component={
            <>
                            ...
                            <>
                                <div className="col-span-full xl:col-span-2">
                                    <div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm col-span-full dark:border-gray-700 dark:bg-gray-800">
                                        <div className="flex flex-col items-center justify-center sm:flex-row lg:flex-row sm:justify-center xl:flex-row xl:justify-center 2xl:flex-row sm:space-x-4 xl:space-x-2 2xl:space-x-4">
                                            { response.loading === false ?
                                                <img className="mb-4 rounded-lg w-28 h-28 sm:mb-0 xl:mb-4 2xl:mb-0" src={ account.profile_image } alt="Jese picture" />
                                            : 
                                                <div role="status" className="space-y-8 animate-pulse md:space-y-0 w-full md:space-x-8 rtl:space-x-reverse md:flex md:items-center">
                                                    <div className="flex items-center justify-center w-28 h-28 bg-gray-300 rounded dark:bg-gray-700">
                                                        <svg className="w-28 h-10 text-gray-200 dark:text-gray-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                                    ...
                                    <div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                                        ...
                                        <div className="grid grid-cols-6 gap-6">
                                            <div className="col-span-6 sm:col-span-3">
                                                ...
                                                <input value={account.name} readOnly type="text" name="name" id="first-name" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Bonnie" required />
                                            </div>
                                            <div className="col-span-6 sm:col-span-3">
                                                <label htmlFor="last-name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Last Name</label>
                                                <input value={account.surname} readOnly type="text" name="surname" id="last-name" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Green" required />
                                            </div>
                                            <div className="col-span-6 sm:col-span-3">
                                                <label htmlFor="gender" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Gender</label>
                                                  <Select name="gender" readOnly id="gender" required>
                                                    <option defaultValue value={account.gender}>{GENDERS[account.gender]}</option>
                                                  </Select>
                                            </div>
                                            <div className="col-span-6 sm:col-span-3">
                                                <label htmlFor="username" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Username</label>
                                                <input name="username" value={account.username} readOnly type="text" id="username" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="johndoe123" required />
                                            </div>
                                        </div>
...
export default connect(null, { getAccount })(Account);
