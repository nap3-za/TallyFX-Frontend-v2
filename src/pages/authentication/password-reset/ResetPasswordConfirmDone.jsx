...
function ResetPasswordConfirmDone(props) {
		    ...
		    <div className="py-24 px-4 mx-auto max-w-screen-xl lg:px-6">
		        <div className="mx-auto max-w-screen-sm text-center">
		            ...
		            <p className="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">
		            	Your password was reset successfully, be sure to save the new password so that you don't forget it.
		            </p>
...
export default ResetPasswordConfirmDone;